...
export class InitialSchema1730000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_a7815967475d0accd76feba8a1" ON "users" ("cnpj") `);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_230b925048540454c8b4c481e1" ON "users" ("cpf") `);
    ...
    await queryRunner.query(`
      DO $$ BEGIN
        CREATE TYPE "public"."orders_status_enum" AS ENUM('PENDING', 'COMPLETED', 'FAILED');
      EXCEPTION WHEN duplicate_object THEN null;
      END $$;
    `);
    await queryRunner.query(
    ...
    await queryRunner.query(`
      DO $$ BEGIN
        ALTER TABLE "orders" ADD CONSTRAINT "FK_ac832121b6c331b084ecc4121fd" FOREIGN KEY ("product_id") REFERENCES "product"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
      EXCEPTION WHEN duplicate_object THEN null;
      END $$;
    `);
  }
